...
## V46 — product enquiries and simplified contact flow
- Removed the quotation feature from the public website and admin dashboard.
- Removed the Solar Savings Calculator from the Solar Solutions page.
- Product modals on Farm Machinery, Solar Solutions and the Products catalogue now have Call and Inquiry actions.
- Farm Machinery product calls use 7735903203; Solar product calls use 9861515980.
- Product inquiries collect name and mobile number and are stored in the existing site/MongoDB document under `enquiries`.
