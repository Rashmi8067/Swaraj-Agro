...
## PM Surya Ghar vendor profile
The Solar Solutions page displays the registered-vendor figures stored under `company.solarVendor`. These are editable from the admin Company section and link to the official PM Surya Ghar registered-vendors portal. The portal does not expose a documented public API in this project, so the displayed figures are intentionally manual rather than scraped.


## v33 changes
- Reduced oversized mobile vertical whitespace on the homepage and inner product pages.
- Gallery Tile View keeps the 5-photo category preview plus a View All tile.
- Gallery List View restored to the earlier full-list presentation across categories.
- View All now opens a dedicated category gallery page with the category heading and a 3-column photo grid on desktop.
- Company admin save now persists PM Surya Ghar vendor figures correctly.
