...
function normalize(data) {
  ...
  data.company.solarVendor.installations = data.company.solarVendor.installations || '111';
  data.company.solarVendor.capacity = data.company.solarVendor.capacity || '333 kWp';
  data.company.solarVendor.rating = data.company.solarVendor.rating || '5.0/5';
  data.company.solarVendor.ratingCount = data.company.solarVendor.ratingCount || '117';
