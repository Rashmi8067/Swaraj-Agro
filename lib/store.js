...
function normalize(data) {
  ...
  data.company.solarVendor = data.company.solarVendor || { name:'DS Swaraj Agro', state:'Odisha', district:'Jajpur', installations:'111', capacity:'333 kWp', rating:'5/5', ratingCount:'117', portalUrl:'https://pmsuryaghar.gov.in/#/registered-vendors' };
